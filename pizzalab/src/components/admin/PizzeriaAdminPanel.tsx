...
const CategoriesEditor = lazy(() => import('./CategoriesEditor').catch(() => ({ default: () => <div>Error loading CategoriesEditor</div> })));
...
const ContactHoursManager = lazy(() => import('./ContactHoursManager').catch(() => ({ default: () => <div>Error loading ContactHoursManager</div> })));
...
// StripeSettings removed - no Stripe integration needed
...
const UploadSystemTester = lazy(() => import('./UploadSystemTester').catch(() => ({ default: () => <div>Error loading UploadSystemTester</div> })));
...
const PizzeriaAdminPanel = () => {
  ...
  // Clean and organized admin sections
  const adminSections = [
    // === CORE BUSINESS ===
    {
      id: 'dashboard',
    ...
    // === CONTENT MANAGEMENT ===
    {
      ...
      icon: Globe,
      description: 'Gestione testi e contenuti del sito web',
      category: 'content'
    },
    {
      id: 'gallery',
      ...
      icon: Image,
      description: 'Gestione immagini e galleria fotografica',
      category: 'content'
    },
    {
      id: 'backgrounds',
      label: 'Sfondi',
      icon: Palette,
      description: 'Gestione sfondi per tutte le sezioni',
      category: 'content'
    },
    {
      id: 'contact-hours',
      ...
      icon: Clock,
      description: 'Gestione informazioni di contatto e orari di apertura',
      category: 'content'
    },
    ...
    // === PAYMENT SYSTEMS ===
    {
      ...
      label: 'SatisPay QR',
      icon: QrCode,
      description: 'Gestione QR code SatisPay per pagamenti',
      category: 'payment'
    },
    ...
    // === ADVANCED TOOLS (for developers) ===
    {
      ...
      label: 'Test Database',
      icon: Database,
      description: 'Test connessione e schema database',
      category: 'advanced'
    },
    {
      id: 'system-test',
      label: 'Test Sistema',
      icon: Wrench,
      description: 'Diagnostica completa del sistema',
      category: 'advanced'
    },
    {
      id: 'satispay-migration',
      label: 'SatisPay Migration',
      icon: Database,
      description: 'Migrazione database per SatisPay QR',
      category: 'advanced'
    }
  ];
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-6">
              ...
              <div>
                ...
                <p className="text-xl text-gray-600 font-semibold">PIZZALAB - Laboratorio di Pizza Italiana</p>
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-8">
          ...
          <div className="bg-gradient-to-br from-white via-gray-50 to-white rounded-3xl shadow-2xl border border-gray-200 p-8 backdrop-blur-sm">
              ...
              <TabsList className="grid grid-cols-1 gap-4 bg-transparent h-auto">
                {adminSections.filter(s => s.category === 'payment').map((section) => (
                  <TabsTrigger
                    key={section.id}
                    value={section.id}
                    className="flex items-center p-4 text-left bg-gradient-to-r from-white to-gray-50 border border-gray-200 rounded-xl hover:shadow-lg hover:border-yellow-300 data-[state=active]:bg-gradient-to-r data-[state=active]:from-yellow-50 data-[state=active]:to-yellow-100 data-[state=active]:border-yellow-400 data-[state=active]:shadow-lg transition-all duration-200 h-auto"
                  >
            ...
            <details className="group">
              ...
              <div className="mt-4">
                <TabsList className="grid grid-cols-1 md:grid-cols-2 gap-3 bg-transparent h-auto">
                  {adminSections.filter(s => s.category === 'advanced').map((section) => (
                    <TabsTrigger
                      key={section.id}
                      value={section.id}
          ...
          <div className="space-y-6">
            ...
            <TabsContent value="contact-hours">
              <Card className="bg-white rounded-2xl shadow-xl border border-gray-200">
                <CardHeader className="bg-gradient-to-r from-green-50 to-green-100 rounded-t-2xl border-b border-green-200">
                  <CardTitle className="flex items-center text-green-800">
                    <div className="bg-green-500 p-2 rounded-lg mr-3">
                    ...
                    Gestione Contatti e Orari
                  </CardTitle>
                  <CardDescription className="text-green-600">
                    Modifica informazioni di contatto e orari di apertura per footer e sezione contatti
                  </CardDescription>
                </CardHeader>
                <CardContent className="p-6">
                  <Suspense fallback={<LoadingSpinner />}>
            ...
            {/* SatisPay QR Management */}
            <TabsContent value="satispay-qr">
              <Card className="bg-white rounded-2xl shadow-xl border border-gray-200">
                <CardHeader className="bg-gradient-to-r from-yellow-50 to-yellow-100 rounded-t-2xl border-b border-yellow-200">
                  <CardTitle className="flex items-center text-yellow-800">
                    <div className="bg-yellow-500 p-2 rounded-lg mr-3">
            ...
            <TabsContent value="settings">
              <div className="space-y-8">
                ...
                {/* Stripe Payment Settings removed - no Stripe integration needed */}
            ...
            {/* Upload System Test */}
            <TabsContent value="upload-system-test">
              <Card>
                <CardHeader>
                  <CardTitle className="flex items-center">
            ...
            {/* SatisPay Migration */}
            <TabsContent value="satispay-migration">
              <Card>
                <CardHeader>
                  <CardTitle className="flex items-center">
                  ...
                  <CardDescription>
                    Migrazione database per abilitare il sistema SatisPay QR
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <Suspense fallback={<LoadingSpinner />}>
