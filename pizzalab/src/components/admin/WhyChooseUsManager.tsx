    ...
    features: [
      {
        id: "1",
        icon: "🧪",
        title: "Innovazione Culinaria",
        description: "Tecniche moderne unite alla tradizione italiana"
      },
      {
        id: "2",
        icon: "🌿",
        title: "Ingredienti Premium",
        description: "Solo i migliori prodotti italiani selezionati"
      },
      {
        id: "3",
        icon: "👨‍🍳",
        title: "Maestri Pizzaioli",
        description: "Esperti artigiani della pizza italiana"
      },
      {
        id: "4",
        icon: "🔬",
        title: "Laboratorio a Vista",
        description: "Guarda i nostri chef all'opera"
      },
      {
        id: "5",
        icon: "🏆",
        title: "Qualità Garantita",
        description: "Ogni pizza è un capolavoro di sapore"
      },
      {
        id: "6",
        icon: "🚀",
        title: "Consegna Rapida",
        description: "Servizio veloce senza compromessi sulla qualità"
      }
    ]
  });
