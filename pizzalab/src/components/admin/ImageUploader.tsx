...
import { uploadFileToStorage } from "@/utils/simpleStorageService";
...
const ImageUploader: React.FC<ImageUploaderProps> = ({
  ...
  const handleImageChange = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      ...
      // Use simplified storage service for better error handling
      const uploadResult = await uploadFileToStorage(correctedFile, bucketName, folderPath);
      ...
      // Use the URL from the simplified storage service
