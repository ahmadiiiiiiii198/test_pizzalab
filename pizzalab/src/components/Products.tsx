...
import redisProductService from '@/services/redisProductService';
...
const Products = () => {
  ...
  // Create section style with background image if available (light theme)
  const sectionStyle = productsContent.backgroundImage
    ? {
        backgroundImage: `linear-gradient(rgba(255, 255, 255, 0.9), rgba(255, 255, 255, 0.8)), url(${productsContent.backgroundImage})`,
  ...
  return (
    <>
      <div
        className="relative py-20 section-light-warm"
        style={{
          minHeight: '100vh',
          width: '100%',
          zIndex: 1,
      ...
      >
        ...
        <div className="container mx-auto px-4 relative z-20">
          <div className="text-center mb-12 animate-fade-in-up card-light-elevated backdrop-blur-sm rounded-2xl p-8 border border-orange-200 shadow-xl">
            <div className="mb-8">
              <div className="flex items-center justify-center space-x-4 mb-6">
                <Pizza className="text-orange-500 animate-pizza-spin" size={48} />
                <ChefHat className="text-orange-500 animate-tomato-bounce" size={48} />
                <Pizza className="text-orange-500 animate-pizza-spin animation-delay-2000" size={48} />
              </div>
              <h2 className="text-4xl md:text-5xl font-bold text-gray-800 mb-6 timeout-heading text-gradient-orange">
                🍕 {productsContent.heading}
              </h2>
            </div>
            <p className="text-xl text-gray-600 max-w-2xl mx-auto font-raleway animate-fade-in-up animate-stagger-1">
