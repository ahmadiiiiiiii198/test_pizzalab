  ...
  const products = [
    {
      ...
      description: "Elegant golden roses perfect for special occasions"
    },
    {
      name: "Garden Fresh Lilies",
      price: "€35.00",
      ...
      description: "Fresh white lilies with delicate fragrance"
    },
    {
      name: "Premium Plant Collection",
      price: "€65.00",
      ...
      description: "Curated selection of indoor plants for your home"
    },
    {
      name: "Romantic Red Roses",
      price: "€55.00",
      image: "https://images.unsplash.com/photo-1465146344425-f00d5f5c8f07?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1000&q=80",
      description: "Classic red roses for moments that matter"
    }
  ];
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            Handpicked flowers and plants, each one carefully selected for its beauty and quality
          </p>
        </div>
