export interface Category {
  ...
  is_active?: boolean;
  aggiunti_enabled?: boolean; // Enable/disable extras feature for this category
  bevande_enabled?: boolean; // Enable/disable drinks feature for this category
  impasto_enabled?: boolean; // Enable/disable impasto (dough type) selection for this category
  sort_order?: number;
