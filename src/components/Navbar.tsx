...
const Navbar = () => {
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 py-4 shadow-lg border-b border-gray-200" style={{backgroundColor: '#ffffff'}}>
      ...
      {/* Mobile Navigation */}
      {isMenuOpen && (
        <div className="md:hidden border-t border-gray-200 py-4 shadow-lg" style={{backgroundColor: '#ffffff'}}>
