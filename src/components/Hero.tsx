...
import { useMongoHeroContent } from '@/hooks/use-mongo-hero';
...
const Hero = () => {
  ...
  // Use the MongoDB hooks to load content from database
  const [heroContent, updateHeroContent, heroLoading] = useMongoHeroContent();
